...
def rows(s: dict) -> list:
    ...
    return [
        ...
        ("line", "M.Tech, Robotics and Machine Intelligence, IIIT Allahabad"),
        ("line", "B.Tech, Computer Science, KMIT Hyderabad, 2020 to 2024"),
        ("line", "Looking for research internships"),
        None,
        ("head", "Research"),
        ("kv", "RL", "Meta-controller over query budget and retraining rate"),
        ("kv", "RL.Domain", "Encrypted VPN traffic under concept drift"),
        ("kv", "RL.Labels", "Active learning when the labels arrive late"),
        ("kv", "Vision", "Attention grounding against VLM hallucination"),
        ("kv", "Vision.Loss", "BCE spatial alignment over token activation maps"),
        ("kv", "Vision.Data", "GroundingDINO and SAM pseudo-labels from COCO"),
        None,
        ("head", "Built"),
        ("kv", "tickerql", "A SQL agent that cannot write to its database"),
        ("kv", "tickerql.live", "tickerql.vercel.app"),
        ("kv", "rag-chatbot", "Retrieval-augmented chat, 4-bit quantised"),
        ("kv", "uav-tracking", "YOLOv7 and SORT on a Raspberry Pi 4, flying"),
        None,
        ("head", "Stack"),
